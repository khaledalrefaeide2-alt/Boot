...
(function (W) {
  ...
  /* رسم أيقونة من مصدر الأيقونات الوحيد. كان مستدعىً في openPicker بلا
     تعريف، فكان زرّ «دليل الصفحات» يرمي ReferenceError ولا يفتح شيئاً —
     عطل صامت لأن الخطأ يقع داخل معالج نقرة فلا يوقف بقية الصفحة.
     يعود فارغاً إن غاب icons.js فتبقى النافذة تعمل بنصّها. */
  const ic = n => (W.FBXIcons ? W.FBXIcons.svg(n) : '');
