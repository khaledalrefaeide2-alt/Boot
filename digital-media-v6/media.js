...
(function (global) {
  ...
  function injectStyles() {
    ...
    /* نسبة أبعاد ثابتة تُملي ارتفاع الإطار. بدونها يرث الإطارُ الارتفاعَ
       الطبيعي للصورة، فصورة طولية 600×900 كانت تمدّ البطاقة إلى 508px
       وتمطّ معها كل بطاقات الصف. النسبة تجعل الارتفاع دالةً لعرض البطاقة
       وحده — متوقَّعاً ومتساوياً بين كل البطاقات. */
